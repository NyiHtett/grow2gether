...
interface ImageSwiperProps {
  /** Comma-separated string OR an array of image URLs.
   *  (Array support added so base64 data URLs — which contain commas — work.) */
      ...
      {cardOrder.map((originalIndex, displayIndex) => (
        <article
          ...
          className="image-card absolute cursor-grab active:cursor-grabbing
                     place-self-center border border-white/25 rounded-2xl
